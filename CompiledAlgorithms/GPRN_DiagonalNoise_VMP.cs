...
namespace gpnetworkVB
{
    ...
    /// This is the GPRN model with diagonal noise, node noise but no mean function.
	/// </summary>
	/// <remarks>
	...
	/// 
	/// Generated by Infer.NET 2.4 beta 3 at 20:00 on 31 October 2011.
	/// </remarks>
    [Serializable]
    public class GPRN_DiagonalNoise_VMP : IGeneratedAlgorithm, INetworkModel
	{
		...
		/// <summary>The number of iterations last computed by Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0. Set this to zero to force re-execution of Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0</summary>
		public int Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone;
		...
		/// <summary>The number of iterations last computed by Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2. Set this to zero to force re-execution of Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2</summary>
		public int Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_iterationsDone;
		/// <summary>True if Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2 has performed initialisation. Set this to false to force re-execution of Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2</summary>
		public bool Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4. Set this to zero to force re-execution of Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4</summary>
		public int Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_iterationsDone;
		/// <summary>True if Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4 has performed initialisation. Set this to false to force re-execution of Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4</summary>
		public bool Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8. Set this to zero to force re-execution of Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8</summary>
		public int Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_iterationsDone;
		/// <summary>True if Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8 has performed initialisation. Set this to false to force re-execution of Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8</summary>
		public bool Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10. Set this to zero to force re-execution of Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10</summary>
		public int Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_iterationsDone;
		/// <summary>True if Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10 has performed initialisation. Set this to false to force re-execution of Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10</summary>
		public bool Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13. Set this to zero to force re-execution of Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13</summary>
		public int Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_iterationsDone;
		/// <summary>True if Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13 has performed initialisation. Set this to false to force re-execution of Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13</summary>
		public bool Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised;
		/// <summary>The number of iterations last computed by Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14. Set this to zero to force re-execution of Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14</summary>
		public int Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_iterationsDone;
		/// <summary>True if Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14 has performed initialisation. Set this to false to force re-execution of Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14</summary>
		public bool Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_isInitialised;
		...
		public DistributionStructArray<Gamma,double> noisePrecision_use_B;
		...
		public DistributionStructArray<Gamma,double> noisePrecision_marginal_F;
		...
		{			get {
			...
			set {
				if (this.q!=value) {
					...
					this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_iterationsDone = 0;
					this.Changed_Q_iterationsDone = 0;
					this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_iterationsDone = 0;
					this.Changed_Q_N_iterationsDone = 0;
					this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_iterationsDone = 0;
					this.Changed_D_Q_iterationsDone = 0;
					this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_iterationsDone = 0;
					this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised = false;
					this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised = false;
					this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
				}
			}
		}
		...
		{			get {
			...
			set {
				...
				this.numberOfIterationsDone = 0;
				this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_isInitialised = false;
				this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_iterationsDone = 0;
				this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised = false;
				this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised = false;
				this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised = false;
				this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
			}
		...
		{			get {
			...
			set {
				if (this.d!=value) {
					...
					this.Changed_N_D_Q_iterationsDone = 0;
					this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_iterationsDone = 0;
					this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_isInitialised = false;
					this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised = false;
					this.Changed_D_Q_iterationsDone = 0;
					this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_iterationsDone = 0;
					this.Changed_D_iterationsDone = 0;
					this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_iterationsDone = 0;
					this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised = false;
					this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
				}
			}
		...
		{			get {
			...
			set {
				...
				this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised = false;
				this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised = false;
				this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_iterationsDone = 0;
				this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
			}
		}
		...
		public object Marginal(string variableName)
		{
            ...
            {
                throw new ApplicationException("This model uses diagonal noise"); 
            }
		...
		{
			if (numberOfIterations<this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone) {
				this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_isInitialised = false;
				this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_isInitialised = false;
				this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised = false;
				this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised = false;
			...
			this.Changed_N_D();
			this.Changed_N_D_Q();
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8(initialise);
			this.Constant();
			this.Changed_Q();
			this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14(initialise);
			this.Changed_Q_N();
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13(initialise);
			this.Changed_D_Q();
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10(initialise);
			this.Changed_D();
			this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4(initialise);
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2(initialise);
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0(numberOfIterations);
		...
		/// <summary>Computations that depend on the observed value of N and D and Q and must reset on changes to numberOfIterationsDecreased and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8(bool initialise)
		{
			if ((this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_iterationsDone==1)&&((!initialise)||this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_isInitialised)) {
				return ;
			}
			for(int n = 0; n<N; n++) {
				for(int d = 0; d<D; d++) {
			...
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_iterationsDone = 1;
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec8_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of Q and nodeNoisePrecisionPrior and must reset on changes to numberOfIterationsDecreased and N and D and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14(bool initialise)
		{
			if ((this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_iterationsDone==1)&&((!initialise)||this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_isInitialised)) {
				return ;
			}
			for(int q = 0; q<Q; q++) {
				this.nodeNoisePrecisions_use_B[q] = ArrayHelper.MakeUniform<Gamma>(this.NodeNoisePrecisionPrior[q]);
			}
			this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_iterationsDone = 1;
			this.Changed_Q_nodeNoisePrecisionPrior_Init_numberOfIterationsDecreased_N_D_K_node_inverse_nodeSignalPrec14_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of Q and N and must reset on changes to numberOfIterationsDecreased and D and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13(bool initialise)
		{
			if ((this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_iterationsDone==1)&&((!initialise)||this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised)) {
				return ;
			}
			for(int q = 0; q<Q; q++) {
				for(int n = 0; n<N; n++) {
			...
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_iterationsDone = 1;
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec13_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of D and Q and must reset on changes to numberOfIterationsDecreased and N and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10(bool initialise)
		{
			if ((this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_iterationsDone==1)&&((!initialise)||this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised)) {
				return ;
			}
			for(int d = 0; d<D; d++) {
				for(int q = 0; q<Q; q++) {
			...
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_iterationsDone = 1;
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrec10_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}
		...
		public void Changed_D()
		{
			...
			// Create array for 'noisePrecision_use' Backwards messages.
			this.noisePrecision_use_B = new DistributionStructArray<Gamma,double>(this.d);
			this.Changed_D_iterationsDone = 1;
			this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_iterationsDone = 0;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}

		/// <summary>Computations that depend on the observed value of D and noisePrecisionPrior and must reset on changes to numberOfIterationsDecreased and Q and N and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4(bool initialise)
		{
			if ((this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_iterationsDone==1)&&((!initialise)||this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised)) {
				return ;
			}
			for(int d = 0; d<D; d++) {
				this.noisePrecision_use_B[d] = ArrayHelper.MakeUniform<Gamma>(this.NoisePrecisionPrior);
			}
			this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_iterationsDone = 1;
			this.Changed_D_noisePrecisionPrior_Init_numberOfIterationsDecreased_Q_N_nodeNoisePrecisionPrior_K_node_in4_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}

		/// <summary>Computations that depend on the observed value of nodeFunctionsInitVar and must reset on changes to numberOfIterationsDecreased and Q and N and D and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and K_weights_inverse</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2(bool initialise)
		{
			if ((this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_iterationsDone==1)&&((!initialise)||this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised)) {
				return ;
			}
			...
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_iterationsDone = 1;
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_i2_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = 0;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and Q and N and D and nodeNoisePrecisionPrior and K_node_inverse and nodeSignalPrecisionsPrior and isMissing and observedData and noisePrecisionPrior and nodeFunctionsInitVar and K_weights_inverse</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		public void Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0(int numberOfIterations)
		{
			if (this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone==numberOfIterations) {
				return ;
			}
			...
			for(int q = 0; q<Q; q++) {
				// Message to 'ev_selector_cases_0_rep9_uses' from VectorGaussianScaled factor
			...
			// Create array for replicates of 'noisePrecision_d_cond_isMissing_d__n__1_B'
			Gamma[][] noisePrecision_d_cond_isMissing_d__n__1_B = new Gamma[this.n][];
			for(int n = 0; n<N; n++) {
				// Create array for replicates of 'noisePrecision_d_cond_isMissing_d__n__1_B'
				noisePrecision_d_cond_isMissing_d__n__1_B[n] = new Gamma[this.d];
				for(int d = 0; d<D; d++) {
					if (!this.IsMissing[d, n]) {
						noisePrecision_d_cond_isMissing_d__n__1_B[n][d] = ArrayHelper.MakeUniform<Gamma>(this.NoisePrecisionPrior);
					}
				}
			}
			DistributionRefArray<DistributionStructArray<Gamma,double>,double[]> noisePrecision_rep0_B = default(DistributionRefArray<DistributionStructArray<Gamma,double>,double[]>);
			// Create array for 'noisePrecision_rep0' Backwards messages.
			noisePrecision_rep0_B = new DistributionRefArray<DistributionStructArray<Gamma,double>,double[]>(this.n);
			for(int n = 0; n<N; n++) {
				// Create array for 'noisePrecision_rep0' Backwards messages.
				noisePrecision_rep0_B[n] = new DistributionStructArray<Gamma,double>(this.d);
				for(int d = 0; d<D; d++) {
					noisePrecision_rep0_B[n][d] = ArrayHelper.MakeUniform<Gamma>(this.NoisePrecisionPrior);
				}
			}
			// Create array for 'noisePrecision_marginal' Forwards messages.
			this.noisePrecision_marginal_F = new DistributionStructArray<Gamma,double>(this.d);
			for(int d = 0; d<D; d++) {
				this.noisePrecision_marginal_F[d] = ArrayHelper.MakeUniform<Gamma>(this.NoisePrecisionPrior);
			}
			...
			for(int d = 0; d<D; d++) {
				...
				this.noisePrecision_marginal_F[d] = VariableVmpOp.MarginalAverageLogarithm<Gamma>(this.noisePrecision_use_B[d], this.NoisePrecisionPrior, this.noisePrecision_marginal_F[d]);
				for(int n = 0; n<N; n++) {
					if (!this.IsMissing[d, n]) {
						// Message to 'noiseLessY_d_n_cond_isMissing_d__n__1' from Gaussian factor
						noiseLessY_d_n_cond_isMissing_d__n__1_B[n][d] = GaussianOp.MeanAverageLogarithm(this.ObservedData[d, n], this.noisePrecision_marginal_F[d]);
			...
			for(int iteration = this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone; iteration<numberOfIterations; iteration++) {
				for(int q = 0; q<Q; q++) {
					// Message to 'nodeFunctionValuesClean' from ArrayFromVector factor
					nodeFunctionValuesClean_F[q] = ArrayFromVectorOp.ArrayAverageLogarithm<DistributionStructArray<Gaussian,double>>(this.nodeFunctions_use_F[q], nodeFunctionValuesClean_F[q]);
					for(int n = 0; n<N; n++) {
				...
				for(int n = 0; n<N; n++) {
					for(int d = 0; d<D; d++) {
						...
						if (!this.IsMissing[d, n]) {
							// Message to 'noisePrecision_d_cond_isMissing_d__n__1' from Gaussian factor
							noisePrecision_d_cond_isMissing_d__n__1_B[n][d] = GaussianOp.PrecisionAverageLogarithm(this.ObservedData[d, n], this.noiseLessY_F[d, n]);
							// Message to 'noisePrecision_rep0' from Copy factor
							noisePrecision_rep0_B[n][d] = Factor.Copy<Gamma>(noisePrecision_d_cond_isMissing_d__n__1_B[n][d]);
						}
					}
				}
				...
				this.noisePrecision_use_B = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Gamma,double>>(noisePrecision_rep0_B, this.noisePrecision_use_B);
				for(int d = 0; d<D; d++) {
					// Message to 'noisePrecision_marginal' from Variable factor
					this.noisePrecision_marginal_F[d] = VariableVmpOp.MarginalAverageLogarithm<Gamma>(this.noisePrecision_use_B[d], this.NoisePrecisionPrior, this.noisePrecision_marginal_F[d]);
					for(int n = 0; n<N; n++) {
			...
			ev_selector_cases_0_uses_B = new Bernoulli[56];
			for(int _ind = 0; _ind<56; _ind++) {
			...
			for(int _ind = 0; _ind<2; _ind++) {
				// Create array for 'ev_selector_cases_0_rep1_uses' Backwards messages.
				ev_selector_cases_0_rep1_uses_B[_ind] = new DistributionStructArray<Bernoulli,bool>(this.d);
				for(int d = 0; d<D; d++) {
					ev_selector_cases_0_rep1_uses_B[_ind][d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
			}
			for(int d = 0; d<D; d++) {
				// Message to 'ev_selector_cases_0_rep1_uses' from Random factor
				ev_selector_cases_0_rep1_uses_B[0][d] = Bernoulli.FromLogOdds(UnaryOp<double>.AverageLogFactor<Gamma>(this.noisePrecision_marginal_F[d], this.NoisePrecisionPrior));
				// Message to 'ev_selector_cases_0_rep1_uses' from Variable factor
				ev_selector_cases_0_rep1_uses_B[1][d] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<Gamma>(this.noisePrecision_marginal_F[d], this.NoisePrecisionPrior));
			}
			...
			ev_selector_cases_0_rep1_B = new DistributionStructArray<Bernoulli,bool>(this.d);
			for(int d = 0; d<D; d++) {
				ev_selector_cases_0_rep1_B[d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
			}
			...
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[5] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep1_B, ev_selector_cases_0_uses_B[5]);
			...
			for(int q = 0; q<Q; q++) {
				...
				for(int d = 0; d<D; d++) {
					// Message to 'ev_selector_cases_0_rep4_rep0_uses' from VectorGaussianScaled factor
					ev_selector_cases_0_rep4_rep0_uses_B[q][0][d] = Bernoulli.FromLogOdds(VectorGaussianScaledPrecisionOp.AverageLogFactor(weightFunctions_B_d__q__SampleMean[q][d], 1, weightFunctions_B_d__q__SampleMean_ESamplePrecisionSample[q][d], _hoist0));
					// Message to 'ev_selector_cases_0_rep4_rep0_uses' from Variable factor
					ev_selector_cases_0_rep4_rep0_uses_B[q][1][d] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<VectorGaussian>(weightFunctions_marginal_F[d, q], _hoist1));
				}
			}
			...
			for(int q = 0; q<Q; q++) {
				// Message to 'ev_selector_cases_0_rep8_uses' from Random factor
				ev_selector_cases_0_rep8_uses_B[0][q] = Bernoulli.FromLogOdds(UnaryOp<double>.AverageLogFactor<Gamma>(this.nodeSignalPrecisions_marginal_F[q], this.NodeSignalPrecisionsPrior[q]));
				// Message to 'ev_selector_cases_0_rep8_uses' from Variable factor
				ev_selector_cases_0_rep8_uses_B[1][q] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<Gamma>(this.nodeSignalPrecisions_marginal_F[q], this.NodeSignalPrecisionsPrior[q]));
			}
			...
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[25] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep8_B, ev_selector_cases_0_uses_B[25]);
			double _hoist3 = default(double);
			_hoist3 = VectorGaussianScaledPrecisionOp.PrecisionMeanLogDet(this.k_node_inverse);
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep9_uses_B = default(DistributionStructArray<Bernoulli,bool>[]);
			// Create array for 'ev_selector_cases_0_rep9_uses' Backwards messages.
			ev_selector_cases_0_rep9_uses_B = new DistributionStructArray<Bernoulli,bool>[2];
			for(int _ind = 0; _ind<2; _ind++) {
				// Create array for 'ev_selector_cases_0_rep9_uses' Backwards messages.
				ev_selector_cases_0_rep9_uses_B[_ind] = new DistributionStructArray<Bernoulli,bool>(this.q);
				for(int q = 0; q<Q; q++) {
					ev_selector_cases_0_rep9_uses_B[_ind][q] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
			}
			for(int q = 0; q<Q; q++) {
				// Message to 'ev_selector_cases_0_rep9_uses' from VectorGaussianScaled factor
				ev_selector_cases_0_rep9_uses_B[0][q] = Bernoulli.FromLogOdds(VectorGaussianScaledPrecisionOp.AverageLogFactor(nodeFunctions_B_q__SampleMean[q], this.nodeSignalPrecisions_marginal_F[q], nodeFunctions_B_q__SampleMean_ESamplePrecisionSample[q], _hoist3));
				// Message to 'ev_selector_cases_0_rep9_uses' from Variable factor
				ev_selector_cases_0_rep9_uses_B[1][q] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<VectorGaussian>(this.nodeFunctions_marginal_F[q], nodeFunctions_F[q]));
			}
			DistributionStructArray<Bernoulli,bool> ev_selector_cases_0_rep9_B = default(DistributionStructArray<Bernoulli,bool>);
			// Create array for 'ev_selector_cases_0_rep9' Backwards messages.
			ev_selector_cases_0_rep9_B = new DistributionStructArray<Bernoulli,bool>(this.q);
			for(int q = 0; q<Q; q++) {
				ev_selector_cases_0_rep9_B[q] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
			}
			...
			// Message to 'ev_selector_cases_0_rep9' from Replicate factor
			ev_selector_cases_0_rep9_B = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep9_uses_B, ev_selector_cases_0_rep9_B);
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[28] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep9_B, ev_selector_cases_0_uses_B[28]);
			// Create array for replicates of 'ev_selector_cases_0_rep11_rep0_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] ev_selector_cases_0_rep11_rep0_uses_B = new DistributionStructArray<Bernoulli,bool>[this.q][];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep11_rep0_uses' Backwards messages.
				ev_selector_cases_0_rep11_rep0_uses_B[q] = new DistributionStructArray<Bernoulli,bool>[2];
				for(int _ind = 0; _ind<2; _ind++) {
					// Create array for 'ev_selector_cases_0_rep11_rep0_uses' Backwards messages.
					ev_selector_cases_0_rep11_rep0_uses_B[q][_ind] = new DistributionStructArray<Bernoulli,bool>(this.n);
					for(int n = 0; n<N; n++) {
						ev_selector_cases_0_rep11_rep0_uses_B[q][_ind][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
					}
				}
				for(int n = 0; n<N; n++) {
					// Message to 'ev_selector_cases_0_rep11_rep0_uses' from Gaussian factor
					ev_selector_cases_0_rep11_rep0_uses_B[q][0][n] = Bernoulli.FromLogOdds(GaussianOp.AverageLogFactor(this.nodeFunctionValues_marginal_F[q][n], nodeFunctionValuesClean_F[q][n], this.nodeNoisePrecisions_marginal_F[q]));
					// Message to 'ev_selector_cases_0_rep11_rep0_uses' from Variable factor
					ev_selector_cases_0_rep11_rep0_uses_B[q][1][n] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<Gaussian>(this.nodeFunctionValues_marginal_F[q][n], nodeFunctionValues_F[q][n]));
				}
			}
			// Create array for replicates of 'ev_selector_cases_0_rep11_rep0_B'
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep11_rep0_B = new DistributionStructArray<Bernoulli,bool>[this.q];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep11_rep0' Backwards messages.
				ev_selector_cases_0_rep11_rep0_B[q] = new DistributionStructArray<Bernoulli,bool>(this.n);
				for(int n = 0; n<N; n++) {
					ev_selector_cases_0_rep11_rep0_B[q][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
				// Message to 'ev_selector_cases_0_rep11_rep0' from Replicate factor
				ev_selector_cases_0_rep11_rep0_B[q] = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep11_rep0_uses_B[q], ev_selector_cases_0_rep11_rep0_B[q]);
			}
			...
			for(int q = 0; q<Q; q++) {
				...
				ev_selector_cases_0_rep11_B[q] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep11_rep0_B[q], ev_selector_cases_0_rep11_B[q]);
			}
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[32] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep11_B, ev_selector_cases_0_uses_B[32]);
			// Create array for replicates of 'ev_selector_cases_0_rep17_rep0_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] ev_selector_cases_0_rep17_rep0_uses_B = new DistributionStructArray<Bernoulli,bool>[this.q][];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep17_rep0_uses' Backwards messages.
				ev_selector_cases_0_rep17_rep0_uses_B[q] = new DistributionStructArray<Bernoulli,bool>[2];
				for(int _ind = 0; _ind<2; _ind++) {
					// Create array for 'ev_selector_cases_0_rep17_rep0_uses' Backwards messages.
					ev_selector_cases_0_rep17_rep0_uses_B[q][_ind] = new DistributionStructArray<Bernoulli,bool>(this.n);
					for(int n = 0; n<N; n++) {
						ev_selector_cases_0_rep17_rep0_uses_B[q][_ind][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
					}
				}
				for(int n = 0; n<N; n++) {
					// Message to 'ev_selector_cases_0_rep17_rep0_uses' from Gaussian factor
					ev_selector_cases_0_rep17_rep0_uses_B[q][0][n] = Bernoulli.FromLogOdds(GaussianOp.AverageLogFactor(this.nodeFunctionValuesPredictive_marginal_F[q][n], nodeFunctionValuesClean_F[q][n], this.nodeNoisePrecisions_marginal_F[q]));
					// Message to 'ev_selector_cases_0_rep17_rep0_uses' from Variable factor
					ev_selector_cases_0_rep17_rep0_uses_B[q][1][n] = Bernoulli.FromLogOdds(VariableVmpOp.AverageLogFactor<Gaussian>(this.nodeFunctionValuesPredictive_marginal_F[q][n], nodeFunctionValuesPredictive_F[q][n]));
				}
			}
			// Create array for replicates of 'ev_selector_cases_0_rep17_rep0_B'
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep17_rep0_B = new DistributionStructArray<Bernoulli,bool>[this.q];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep17_rep0' Backwards messages.
				ev_selector_cases_0_rep17_rep0_B[q] = new DistributionStructArray<Bernoulli,bool>(this.n);
				for(int n = 0; n<N; n++) {
					ev_selector_cases_0_rep17_rep0_B[q][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
				// Message to 'ev_selector_cases_0_rep17_rep0' from Replicate factor
				ev_selector_cases_0_rep17_rep0_B[q] = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep17_rep0_uses_B[q], ev_selector_cases_0_rep17_rep0_B[q]);
			}
			DistributionStructArray<Bernoulli,bool> ev_selector_cases_0_rep17_B = default(DistributionStructArray<Bernoulli,bool>);
			// Create array for 'ev_selector_cases_0_rep17' Backwards messages.
			ev_selector_cases_0_rep17_B = new DistributionStructArray<Bernoulli,bool>(this.q);
			for(int q = 0; q<Q; q++) {
				ev_selector_cases_0_rep17_B[q] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				// Message to 'ev_selector_cases_0_rep17' from Replicate factor
				ev_selector_cases_0_rep17_B[q] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep17_rep0_B[q], ev_selector_cases_0_rep17_B[q]);
			}
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[43] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep17_B, ev_selector_cases_0_uses_B[43]);
			// Create array for replicates of 'ev_selector_cases_0_rep21_rep0_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] ev_selector_cases_0_rep21_rep0_uses_B = new DistributionStructArray<Bernoulli,bool>[this.n][];
			for(int n = 0; n<N; n++) {
				// Create array for 'ev_selector_cases_0_rep21_rep0_uses' Backwards messages.
				ev_selector_cases_0_rep21_rep0_uses_B[n] = new DistributionStructArray<Bernoulli,bool>[5];
				for(int _ind = 0; _ind<5; _ind++) {
					// Create array for 'ev_selector_cases_0_rep21_rep0_uses' Backwards messages.
					ev_selector_cases_0_rep21_rep0_uses_B[n][_ind] = new DistributionStructArray<Bernoulli,bool>(this.d);
					for(int d = 0; d<D; d++) {
						ev_selector_cases_0_rep21_rep0_uses_B[n][_ind][d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
					}
				}
				for(int d = 0; d<D; d++) {
					if (!this.IsMissing[d, n]) {
						// Message to 'ev_selector_cases_0_rep21_rep0_uses' from Gaussian factor
						ev_selector_cases_0_rep21_rep0_uses_B[n][4][d] = Bernoulli.FromLogOdds(GaussianOp.AverageLogFactor(this.ObservedData[d, n], this.noiseLessY_F[d, n], this.noisePrecision_marginal_F[d]));
					}
				}
			}
			// Create array for replicates of 'ev_selector_cases_0_rep21_rep0_B'
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep21_rep0_B = new DistributionStructArray<Bernoulli,bool>[this.n];
			for(int n = 0; n<N; n++) {
				// Create array for 'ev_selector_cases_0_rep21_rep0' Backwards messages.
				ev_selector_cases_0_rep21_rep0_B[n] = new DistributionStructArray<Bernoulli,bool>(this.d);
				for(int d = 0; d<D; d++) {
					ev_selector_cases_0_rep21_rep0_B[n][d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
				// Message to 'ev_selector_cases_0_rep21_rep0' from Replicate factor
				ev_selector_cases_0_rep21_rep0_B[n] = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep21_rep0_uses_B[n], ev_selector_cases_0_rep21_rep0_B[n]);
			}
			...
			ev_selector_cases_0_rep21_B = new DistributionStructArray<Bernoulli,bool>(this.n);
			for(int n = 0; n<N; n++) {
				ev_selector_cases_0_rep21_B[n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				// Message to 'ev_selector_cases_0_rep21' from Replicate factor
				ev_selector_cases_0_rep21_B[n] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep21_rep0_B[n], ev_selector_cases_0_rep21_B[n]);
			}
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[52] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep21_B, ev_selector_cases_0_uses_B[52]);
			...
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[55] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep22_B, ev_selector_cases_0_uses_B[55]);
			...
			this.Changed_numberOfIterationsDecreased_Q_N_D_nodeNoisePrecisionPrior_K_node_inverse_nodeSignalPrecision0_iterationsDone = numberOfIterations;
		}
		...
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gamma,double> NoisePrecisionMarginal()
		{
