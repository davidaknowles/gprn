...
namespace gpnetworkVB
{
	...
	/// 
	/// Generated by Infer.NET 2.4 beta 2 at 16:56 on 18 August 2011.
	/// </remarks>
    public class VMPModel_nodeNoise : IGeneratedAlgorithm
	{
		...
		/// <summary>The number of iterations last computed by Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0. Set this to zero to force re-execution of Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0</summary>
		public int Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone;
		...
		/// <summary>The number of iterations last computed by Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4. Set this to zero to force re-execution of Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4</summary>
		public int Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_iterationsDone;
		/// <summary>True if Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4 has performed initialisation. Set this to false to force re-execution of Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4</summary>
		public bool Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8. Set this to zero to force re-execution of Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8</summary>
		public int Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_iterationsDone;
		/// <summary>True if Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8 has performed initialisation. Set this to false to force re-execution of Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8</summary>
		public bool Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_isInitialised;
		/// <summary>The number of iterations last computed by Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9. Set this to zero to force re-execution of Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9</summary>
		public int Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_iterationsDone;
		/// <summary>True if Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9 has performed initialisation. Set this to false to force re-execution of Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9</summary>
		public bool Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_isInitialised;
		/// <summary>The number of iterations last computed by Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10. Set this to zero to force re-execution of Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10</summary>
		public int Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_iterationsDone;
		/// <summary>True if Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10 has performed initialisation. Set this to false to force re-execution of Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10</summary>
		public bool Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12. Set this to zero to force re-execution of Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12</summary>
		public int Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_iterationsDone;
		/// <summary>True if Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12 has performed initialisation. Set this to false to force re-execution of Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12</summary>
		public bool Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_isInitialised;
		...
		public DistributionStructArray<Gamma,double> nodeNoisePrecisions_marginal_B;
		...
		{			get {
			...
			set {
				if (this.q!=value) {
					...
					this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_iterationsDone = 0;
					this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_isInitialised = false;
					this.Changed_Q_iterationsDone = 0;
					this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_iterationsDone = 0;
					this.Changed_Q_N_iterationsDone = 0;
					this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_iterationsDone = 0;
					this.Changed_N_D_Q_iterationsDone = 0;
					this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_iterationsDone = 0;
					this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
				}
			}
		}
		...
		{			get {
			...
			set {
				...
				this.numberOfIterationsDone = 0;
				this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_isInitialised = false;
				this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_iterationsDone = 0;
				this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_isInitialised = false;
				this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_isInitialised = false;
				this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
			}
		}
		...
		{
			if (numberOfIterations<this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone) {
				this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_isInitialised = false;
				this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_isInitialised = false;
				this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_isInitialised = false;
				this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_isInitialised = false;
			...
			this.Constant();
			this.Changed_D_Q();
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12(initialise);
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10(initialise);
			this.Changed_Q();
			this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9(initialise);
			this.Changed_Q_N();
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8(initialise);
			this.Changed_N();
			this.Changed_N_D();
			this.Changed_N_D_Q();
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4(initialise);
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0(numberOfIterations);
		...
		/// <summary>Computations that depend on the observed value of D and Q and must reset on changes to numberOfIterationsDecreased and N and observedData and K_node_inverse and K_weights_inverse and nodeFunctionsInitVar</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12(bool initialise)
		{
			if ((this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_iterationsDone==1)&&((!initialise)||this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_isInitialised)) {
				return ;
			}
			for(int d = 0; d<D; d++) {
				for(int q = 0; q<Q; q++) {
			...
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_iterationsDone = 1;
			this.Changed_D_Q_Init_numberOfIterationsDecreased_N_observedData_K_node_inverse_K_weights_inverse_nodeFun12_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10(bool initialise)
		{
			if ((this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_iterationsDone==1)&&((!initialise)||this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_isInitialised)) {
				return ;
			}
			...
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_iterationsDone = 1;
			this.Changed_nodeFunctionsInitVar_Init_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_we10_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of Q and must reset on changes to numberOfIterationsDecreased and N and D and observedData and K_node_inverse and K_weights_inverse and nodeFunctionsInitVar</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9(bool initialise)
		{
			if ((this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_iterationsDone==1)&&((!initialise)||this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_isInitialised)) {
				return ;
			}
			for(int q = 0; q<Q; q++) {
				this.nodeNoisePrecisions_use_B[q] = ArrayHelper.MakeUniform<Gamma>(Gamma.Uniform());
			}
			this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_iterationsDone = 1;
			this.Changed_Q_Init_numberOfIterationsDecreased_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFun9_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of Q and N and must reset on changes to numberOfIterationsDecreased and D and observedData and K_node_inverse and K_weights_inverse and nodeFunctionsInitVar</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8(bool initialise)
		{
			if ((this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_iterationsDone==1)&&((!initialise)||this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_isInitialised)) {
				return ;
			}
			for(int q = 0; q<Q; q++) {
				for(int n = 0; n<N; n++) {
			...
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_iterationsDone = 1;
			this.Changed_Q_N_Init_numberOfIterationsDecreased_D_observedData_K_node_inverse_K_weights_inverse_nodeFun8_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
		}
		...
		/// <summary>Computations that depend on the observed value of N and D and Q and must reset on changes to numberOfIterationsDecreased and observedData and K_node_inverse and K_weights_inverse and nodeFunctionsInitVar</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		public void Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4(bool initialise)
		{
			if ((this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_iterationsDone==1)&&((!initialise)||this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_isInitialised)) {
				return ;
			}
			for(int n = 0; n<N; n++) {
				for(int d = 0; d<D; d++) {
			...
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_iterationsDone = 1;
			this.Changed_N_D_Q_Init_numberOfIterationsDecreased_observedData_K_node_inverse_K_weights_inverse_nodeFun4_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = 0;
		}

        public void OptimiseNodeLogLengthscale_old(Vector[] functions_SampleMean,
            ...
            double L_K_node)
        {
            ...
            Converter<double, double> f = ll =>
            {
                var prec = K_node_inverse_func(ll);
                var logDetPrec = VectorGaussianScaledPrecisionOp.PrecisionMeanLogDet(prec);
                double res = priorOnNodeLogLengthScale.GetLogProb(ll);
                for (int q = 0; q < Q; q++)
                    res += VectorGaussianScaledPrecisionOp.AverageLogFactor(functions_SampleMean[q], this.nodeSignalPrecisions_marginal_B[q],
                        VectorGaussianScaledPrecisionOp.ESamplePrecisionSample(functions_SampleMean[q], functions_SampleVariance[q], prec),
                        logDetPrec);
                return res;
            };

            nodeLogLengthScale = MyOptimiser(f, nodeLogLengthScale, L_K_node);
            //Console.WriteLine("Node ll {0}, likelihood went from {1} to {2}", nodeLogLengthScale, L_K_node, f(nodeLogLengthScale));
        }
            ...
            double L_K_weight)
        {
            ...
            Converter<double, double> f = ll =>
            {
                var prec = K_weight_inverse_func(ll);
                var logDetPrec = VectorGaussianScaledPrecisionOp.PrecisionMeanLogDet(prec);
                double res = priorOnNodeLogLengthScale.GetLogProb(ll);
                for (int q = 0; q < Q; q++)
                    for (int d = 0; d < D; d++)
                        res += VectorGaussianScaledPrecisionOp.AverageLogFactor(functions_SampleMean[q][d], 1,
                            VectorGaussianScaledPrecisionOp.ESamplePrecisionSample(functions_SampleMean[q][d], functions_SampleVariance[q][d], prec),
                            logDetPrec);
                    return res;
            };

            weightsLogLengthScale = MyOptimiser(f, weightsLogLengthScale, L_K_weight);
            //Console.WriteLine("Weight ll {0}, likelihood went from {1} to {2}", weightsLogLengthScale, L_K_weight, f(weightsLogLengthScale));
        }

        // univariate optimiser
        private static double MyOptimiser(Converter<double,double> f, double x0, double f0)
        {
            double eps = 0.1;
        ...
        public void OptimiseWeightLogLengthscale_old(Vector[][] functions_SampleMean,
            double[][] functions_ESamplePrecisionSample,
            PositiveDefiniteMatrix[][] functions_SampleVariance,
            double L_K_weight)
        {
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and Q and N and D and observedData and K_node_inverse and K_weights_inverse and nodeFunctionsInitVar</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		public void Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0(int numberOfIterations)
		{
			if (this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone==numberOfIterations) {
				return ;
			}
			...
			for(int q = 0; q<Q; q++) {
				...
				for(int n = 0; n<N; n++) {
					nodeNoisePrecisions_rep0_B[q][n] = ArrayHelper.MakeUniform<Gamma>(Gamma.Uniform());
				}
			}
			// Message to marginal of 'nodeFunctionValues'
			DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]> nodeFunctionValues_marginal_B = default(DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>);
			// Create array for 'nodeFunctionValues_marginal' Backwards messages.
			nodeFunctionValues_marginal_B = new DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>(this.q);
			for(int q = 0; q<Q; q++) {
				// Create array for 'nodeFunctionValues_marginal' Backwards messages.
				nodeFunctionValues_marginal_B[q] = new DistributionStructArray<Gaussian,double>(this.n);
				for(int n = 0; n<N; n++) {
					nodeFunctionValues_marginal_B[q][n] = ArrayHelper.MakeUniform<Gaussian>(Gaussian.Uniform());
				}
			}
			...
			for(int q = 0; q<Q; q++) {
				...
				for(int _ind0 = 0; _ind0<N; _ind0++) {
					nodeFunctionValuesClean_F[q][_ind0] = ArrayHelper.MakeUniform<Gaussian>(new Gaussian());
				}
			}
			Gamma _hoist1 = default(Gamma);
			_hoist1 = GammaFromShapeAndRateOp.YAverageLogarithm(0.1, 0.01);
			// Create array for 'nodeNoisePrecisions_marginal' Backwards messages.
			this.nodeNoisePrecisions_marginal_B = new DistributionStructArray<Gamma,double>(this.q);
			for(int q = 0; q<Q; q++) {
				this.nodeNoisePrecisions_marginal_B[q] = ArrayHelper.MakeUniform<Gamma>(Gamma.Uniform());
			}
			...
			for(int q = 0; q<Q; q++) {
				...
				for(int _ind0 = 0; _ind0<N; _ind0++) {
					nodeFunctionValuesClean_B[q][_ind0] = ArrayHelper.MakeUniform<Gaussian>(new Gaussian());
				}
			}
			...
			VectorGaussian _hoist5 = default(VectorGaussian);
			for(int q = 0; q<Q; q++) {
				for(int d = 0; d<D; d++) {
					_hoist5 = ArrayHelper.CopyStorage<VectorGaussian>(weightFunctions_F[d, q]);
					q = this.q-1;
					d = this.d-1;
				}
			}
			_hoist5 = VectorGaussianScaledPrecisionOp.SampleAverageLogarithm(1, this.k_weights_inverse, _hoist5);
			...
			for(int q = 0; q<Q; q++) {
				...
				this.nodeNoisePrecisions_marginal_B[q] = VariableVmpBufferOp.MarginalAverageLogarithm<Gamma>(this.nodeNoisePrecisions_use_B[q], _hoist1, this.nodeNoisePrecisions_marginal_B[q]);
				for(int d = 0; d<D; d++) {
					// Message to 'weightFunctions_marginal' from Variable factor
					weightFunctions_marginal_B[d, q] = VariableVmpBufferOp.MarginalAverageLogarithm<VectorGaussian>(this.weightFunctions_use_B[d, q], _hoist5, weightFunctions_marginal_B[d, q]);
				...
				for(int n = 0; n<N; n++) {
					...
					nodeFunctionValues_F[q][n] = GaussianOp.SampleAverageLogarithm(nodeFunctionValuesClean_F[q][n], this.nodeNoisePrecisions_marginal_B[q]);
					// Message to 'nodeFunctionValues_marginal' from Variable factor
					nodeFunctionValues_marginal_B[q][n] = VariableVmpBufferOp.MarginalAverageLogarithm<Gaussian>(this.nodeFunctionValues_use_B[q][n], nodeFunctionValues_F[q][n], nodeFunctionValues_marginal_B[q][n]);
				}
			}
			for(int iteration = this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone; iteration<numberOfIterations; iteration++) {
				for(int q = 0; q<Q; q++) {
					for(int n = 0; n<N; n++) {
						for(int d = 0; d<D; d++) {
							// Message to 'temp' from Product factor
							temp_F[n][d][q] = GaussianProductVmpOp.ProductAverageLogarithm(weightFunctionValues_F[d, q][n], nodeFunctionValues_marginal_B[q][n]);
						}
					}
				}
				for(int n = 0; n<N; n++) {
				...
				for(int n = 0; n<N; n++) {
					for(int d = 0; d<D; d++) {
						...
						for(int q = 0; q<Q; q++) {
							...
							weightFunctionValues_B[d, q][n] = GaussianProductVmpOp.AAverageLogarithm(this.temp_B[n][d][q], nodeFunctionValues_marginal_B[q][n]);
						}
					}
				}
				for(int q = 0; q<Q; q++) {
				...
				for(int q = 0; q<Q; q++) {
					...
					for(int n = 0; n<N; n++) {
						...
						nodeNoisePrecisions_rep0_B[q][n] = GaussianOp.PrecisionAverageLogarithm(nodeFunctionValues_marginal_B[q][n], nodeFunctionValuesClean_F[q][n]);
					}
					// Message to 'nodeNoisePrecisions_use' from Replicate factor
					this.nodeNoisePrecisions_use_B[q] = ReplicateOp.DefAverageLogarithm<Gamma>(nodeNoisePrecisions_rep0_B[q], this.nodeNoisePrecisions_use_B[q]);
					// Message to 'nodeNoisePrecisions_marginal' from Variable factor
					this.nodeNoisePrecisions_marginal_B[q] = VariableVmpBufferOp.MarginalAverageLogarithm<Gamma>(this.nodeNoisePrecisions_use_B[q], _hoist1, this.nodeNoisePrecisions_marginal_B[q]);
					for(int n = 0; n<N; n++) {
						// Message to 'nodeFunctionValuesClean' from Gaussian factor
						nodeFunctionValuesClean_B[q][n] = GaussianOp.MeanAverageLogarithm(nodeFunctionValues_marginal_B[q][n], this.nodeNoisePrecisions_marginal_B[q]);
					}
			...
			ev_selector_cases_0_uses_B = new Bernoulli[42];
			for(int _ind = 0; _ind<42; _ind++) {
			...
			for(int q = 0; q<Q; q++) {
				// Message to 'ev_selector_cases_0_rep1_uses' from GammaFromShapeAndRate factor
				ev_selector_cases_0_rep1_uses_B[0][q] = Bernoulli.FromLogOdds(GammaFromShapeAndRateOp.AverageLogFactor(this.nodeNoisePrecisions_marginal_B[q], 0.1, 0.01));
				// Message to 'ev_selector_cases_0_rep1_uses' from Variable factor
				ev_selector_cases_0_rep1_uses_B[1][q] = Bernoulli.FromLogOdds(VariableVmpBufferOp.AverageLogFactor<Gamma>(this.nodeNoisePrecisions_marginal_B[q]));
			}
			...
			double logDetKNodePrec = default(double);
			logDetKNodePrec = VectorGaussianScaledPrecisionOp.PrecisionMeanLogDet(this.k_node_inverse);
            ...
            double L_K_node = 0; 
			for(int q = 0; q<Q; q++) {
                double temp = VectorGaussianScaledPrecisionOp.AverageLogFactor(nodeFunctions_B_q__SampleMean[q], this.nodeSignalPrecisions_marginal_B[q], nodeFunctions_B_q__SampleMean_ESamplePrecisionSample[q], logDetKNodePrec); 
				// Message to 'ev_selector_cases_0_rep2_uses' from VectorGaussianScaled factor
				...
				ev_selector_cases_0_rep2_uses_B[1][q] = Bernoulli.FromLogOdds(VariableVmpBufferOp.AverageLogFactor<VectorGaussian>(this.nodeFunctions_marginal_B[q]));
			}


            //---------------------- OPTIMISE NODE LOG LENGTH SCALE ---------------------------------
            if (Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone
			...
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[14] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep2_B, ev_selector_cases_0_uses_B[14]);
			// Create array for replicates of 'ev_selector_cases_0_rep6_rep0_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] ev_selector_cases_0_rep6_rep0_uses_B = new DistributionStructArray<Bernoulli,bool>[this.q][];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep6_rep0_uses' Backwards messages.
				ev_selector_cases_0_rep6_rep0_uses_B[q] = new DistributionStructArray<Bernoulli,bool>[2];
				for(int _ind = 0; _ind<2; _ind++) {
					// Create array for 'ev_selector_cases_0_rep6_rep0_uses' Backwards messages.
					ev_selector_cases_0_rep6_rep0_uses_B[q][_ind] = new DistributionStructArray<Bernoulli,bool>(this.n);
					for(int n = 0; n<N; n++) {
						ev_selector_cases_0_rep6_rep0_uses_B[q][_ind][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
					}
				}
				for(int n = 0; n<N; n++) {
					// Message to 'ev_selector_cases_0_rep6_rep0_uses' from Gaussian factor
					ev_selector_cases_0_rep6_rep0_uses_B[q][0][n] = Bernoulli.FromLogOdds(GaussianOp.AverageLogFactor(nodeFunctionValues_marginal_B[q][n], nodeFunctionValuesClean_F[q][n], this.nodeNoisePrecisions_marginal_B[q]));
					// Message to 'ev_selector_cases_0_rep6_rep0_uses' from Variable factor
					ev_selector_cases_0_rep6_rep0_uses_B[q][1][n] = Bernoulli.FromLogOdds(VariableVmpBufferOp.AverageLogFactor<Gaussian>(nodeFunctionValues_marginal_B[q][n]));
				}
			}
			// Create array for replicates of 'ev_selector_cases_0_rep6_rep0_B'
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep6_rep0_B = new DistributionStructArray<Bernoulli,bool>[this.q];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep6_rep0' Backwards messages.
				ev_selector_cases_0_rep6_rep0_B[q] = new DistributionStructArray<Bernoulli,bool>(this.n);
				for(int n = 0; n<N; n++) {
					ev_selector_cases_0_rep6_rep0_B[q][n] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
				// Message to 'ev_selector_cases_0_rep6_rep0' from Replicate factor
				ev_selector_cases_0_rep6_rep0_B[q] = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep6_rep0_uses_B[q], ev_selector_cases_0_rep6_rep0_B[q]);
			}
			DistributionStructArray<Bernoulli,bool> ev_selector_cases_0_rep6_B = default(DistributionStructArray<Bernoulli,bool>);
			// Create array for 'ev_selector_cases_0_rep6' Backwards messages.
			ev_selector_cases_0_rep6_B = new DistributionStructArray<Bernoulli,bool>(this.q);
			for(int q = 0; q<Q; q++) {
				ev_selector_cases_0_rep6_B[q] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				// Message to 'ev_selector_cases_0_rep6' from Replicate factor
				ev_selector_cases_0_rep6_B[q] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep6_rep0_B[q], ev_selector_cases_0_rep6_B[q]);
			}
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[22] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep6_B, ev_selector_cases_0_uses_B[22]);
			// Buffer for VectorGaussianScaledPrecisionOp.SampleMean
			...
			for(int q = 0; q<Q; q++) {
				...
				for(int d = 0; d<D; d++) {
					// Message to 'ev_selector_cases_0_rep8_rep0_uses' from VectorGaussianScaled factor
			...
			double logDetKWeightsPrec = default(double);
			logDetKWeightsPrec = VectorGaussianScaledPrecisionOp.PrecisionMeanLogDet(this.k_weights_inverse);
			// Create array for replicates of 'ev_selector_cases_0_rep8_rep0_uses_B'
			DistributionStructArray<Bernoulli,bool>[][] ev_selector_cases_0_rep8_rep0_uses_B = new DistributionStructArray<Bernoulli,bool>[this.q][];
            double L_K_weight = 0; 
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep8_rep0_uses' Backwards messages.
				ev_selector_cases_0_rep8_rep0_uses_B[q] = new DistributionStructArray<Bernoulli,bool>[2];
				for(int _ind = 0; _ind<2; _ind++) {
					// Create array for 'ev_selector_cases_0_rep8_rep0_uses' Backwards messages.
					ev_selector_cases_0_rep8_rep0_uses_B[q][_ind] = new DistributionStructArray<Bernoulli,bool>(this.d);
					for(int d = 0; d<D; d++) {
						ev_selector_cases_0_rep8_rep0_uses_B[q][_ind][d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
					}
				}
				for(int d = 0; d<D; d++) {
                    double temp = VectorGaussianScaledPrecisionOp.AverageLogFactor(weightFunctions_B_d__q__SampleMean[q][d], 1, weightFunctions_B_d__q__SampleMean_ESamplePrecisionSample[q][d], logDetKWeightsPrec);
					// Message to 'ev_selector_cases_0_rep8_rep0_uses' from VectorGaussianScaled factor
                    ev_selector_cases_0_rep8_rep0_uses_B[q][0][d] = Bernoulli.FromLogOdds(temp);
                    L_K_weight += temp;
					// Message to 'ev_selector_cases_0_rep8_rep0_uses' from Variable factor
					ev_selector_cases_0_rep8_rep0_uses_B[q][1][d] = Bernoulli.FromLogOdds(VariableVmpBufferOp.AverageLogFactor<VectorGaussian>(weightFunctions_marginal_B[d, q]));
				}
			}
			...
			// Create array for replicates of 'ev_selector_cases_0_rep8_rep0_B'
			DistributionStructArray<Bernoulli,bool>[] ev_selector_cases_0_rep8_rep0_B = new DistributionStructArray<Bernoulli,bool>[this.q];
			for(int q = 0; q<Q; q++) {
				// Create array for 'ev_selector_cases_0_rep8_rep0' Backwards messages.
				ev_selector_cases_0_rep8_rep0_B[q] = new DistributionStructArray<Bernoulli,bool>(this.d);
				for(int d = 0; d<D; d++) {
					ev_selector_cases_0_rep8_rep0_B[q][d] = ArrayHelper.MakeUniform<Bernoulli>(new Bernoulli());
				}
				// Message to 'ev_selector_cases_0_rep8_rep0' from Replicate factor
				ev_selector_cases_0_rep8_rep0_B[q] = ReplicateOp.DefAverageLogarithm<DistributionStructArray<Bernoulli,bool>>(ev_selector_cases_0_rep8_rep0_uses_B[q], ev_selector_cases_0_rep8_rep0_B[q]);
			}
			...
			for(int q = 0; q<Q; q++) {
				...
				ev_selector_cases_0_rep8_B[q] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep8_rep0_B[q], ev_selector_cases_0_rep8_B[q]);
			}
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[27] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep8_B, ev_selector_cases_0_uses_B[27]);
			...
			for(int n = 0; n<N; n++) {
				...
				for(int d = 0; d<D; d++) {
					...
					ev_selector_cases_0_rep16_rep0_B[n][d] = Bernoulli.FromLogOdds(GaussianOp.AverageLogFactor(this.ObservedData[d, n], sum_F[n][d], this.noisePrecision_marginal_B));
				}
			}
			...
			// Message to 'ev_selector_cases_0_uses' from Replicate factor
			ev_selector_cases_0_uses_B[38] = ReplicateOp.DefAverageLogarithm<Bernoulli>(ev_selector_cases_0_rep16_B, ev_selector_cases_0_uses_B[38]);
			...
			this.Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0_iterationsDone = numberOfIterations;
		}
		...
		{
			return this.nodeNoisePrecisions_marginal_B;
		}
