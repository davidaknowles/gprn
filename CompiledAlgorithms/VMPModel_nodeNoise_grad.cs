...
namespace gpnetworkVB
{
	...
	/// </remarks>
    public class VMPModel_nodeNoise_grad : IGeneratedAlgorithm
	{
		#region Fields
		...
		public void Changed_numberOfIterationsDecreased_Q_N_D_observedData_K_node_inverse_K_weights_inverse_nodeFunction0(int numberOfIterations)
		{
            ...
            {
                OptimiseNodeHypers(nodeFunctions_B_q__SampleMean, nodeFunctions_B_q__SampleMean_ESamplePrecisionSample, nodeFunctions_B_q__SampleVariance, L_K_node);
            }
            ...
            {
                OptimiseWeightHypers(weightFunctions_B_d__q__SampleMean, weightFunctions_B_d__q__SampleMean_ESamplePrecisionSample,
